...
Implements design.md §6 (format), §2.3 (sentinels), §2.4 (dtypes).
...
#: Industry-common null sentinels used as defaults (design.md §6). 0 is never a sentinel.
...
#: becomes float32 (design.md §6). Example matches: XCORD_MIDPT, YCORD_MIDPT.
